  ...
  <div>
    ...
    >
      <div class="flex flex-col items-center justify-between lg:px-10 mx-auto max-w-7xl xl:px-5 lg:flex-row">
        <div class="flex flex-col items-center w-full px-10 pt-5 pb-20 lg:pt-20 lg:flex-row lg:justify-between">
          <div class="relative w-full max-w-md lg:max-w-full bg-cover lg:flex-1">
            <div class="relative flex flex-col items-center justify-center w-full h-full lg:pr-10">
              <img src="https://assets-global.website-files.com/5ea823e1cf6ee17f763dcc39/60dbd0c6d5bf0c6ad3edaf37_Ojo-ByBolt-angle-Red.png">
            </div>
          </div>
          <div class="relative z-10 w-full max-w-2xl mt-20 lg:mt-0 lg:w-6/12">
            <div class="relative z-10 flex flex-col items-start justify-start p-10 bg-white w-full shadow-2xl rounded-xl">
              <h4 class="w-full font-serif text-3xl lg:text-4xl font-medium leading-snug">
              ...
              <div class="relative w-full mt-6 space-y-8">
                ...
                <div class="relative">
                  <label class="absolute px-2 ml-2 -mt-3 font-medium text-gray-600 bg-white">Service Needed</label>
                  <textarea class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" placeholder="Describe a service you are requesting for" />
                </div>
                <div class="relative">
                  <button class="inline-block w-full px-5 py-4 text-xl font-medium text-center text-white transition duration-200 bg-yellow-300 rounded-lg hover:bg-yellow-400 ease" @click="() => {}">
                    Submit
                  </button>
                </div>
              </div>
