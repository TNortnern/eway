<template>
  <Popover class="relative pb-6 lg:pb-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      ...
      >
        ...
        <div class="-mr-2 -my-2 md:hidden">
          <PopoverButton
            class=" rounded-md p-2 inline-flex items-center justify-center text-gray-100 hover:text-gray-200 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-yellow-400"
          >
        ...
        <PopoverGroup as="nav" class="hidden md:flex space-x-10">
          <!-- <Popover v-slot="{ open }" class="relative">
            <PopoverButton
              :class="[open ? 'text-gray-900' : 'text-gray-500', 'group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-400']"
            >
              <span>Solutions</span>
              <ChevronDownIcon
          ...
          <a
            ...
            :key="text"
            :href="href"
            class="text-base font-medium text-gray-50 hover:(text-gray-300 underline) duration-100"
          >{{ text }}</a>
                ...
                >
                  ...
                  <div class="px-5 py-5 bg-gray-50 sm:px-8 sm:py-8">
                    ...
                    <div class="mt-5 text-sm">
                      <a
                        href="#"
                        class="font-medium text-yellow-400 hover:text-yellow-400"
                      >
                        View all posts
          ...
          <div class="py-6 px-5 space-y-6">
            ...
            <div>
              ...
              <!-- <p class="mt-6 text-center text-base font-medium text-gray-500">
                ...
                <a
                  href="#"
                  class="text-yellow-400 hover:text-yellow-400"
                >Sign in</a>
              </p> -->
            </div>
          </div>
