  ...
  <div>
    ...
    >
      <div class="px-16 bg-white">
        <div class="container flex flex-col items-start mx-auto lg:items-center text-center md:text-left">
          <p class="relative flex items-start justify-start w-full text-lg lg:text-lg font-bold tracking-wider text-yellow-400 uppercase lg:justify-center lg:items-center">
            Don't just take our word for it
          </p>
          <h2 class="relative flex items-start justify-start w-full max-w-3xl lg:(text-5xl) text-3xl font-bold lg:justify-center">
