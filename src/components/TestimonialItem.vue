<template>
  <a
    :href="href || '#'"
    target="__blank"
    class="flex flex-col items-start lg:text-left text-center justify-start w-full h-auto mb-12 lg:w-1/3 lg:mb-0 hover:(opacity-100) opacity-69 duration-150"
    :class="{
      'lg:border-gray-200 lg:mx-5 lg:px-5': borderRight || borderLeft,
      'lg:border-l': borderLeft,
  ...
  >
    ...
    <blockquote class="text-xl text-gray-500 h-28 mt-4">
      {{ testimonial || 'Amet atque nihil eius ea.' }}
    </blockquote>
    <div class="flex justify-center items-center mt-2">
      <div class="flex items-center gap-x-1 mt-2 mb-4">
